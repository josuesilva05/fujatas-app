...
import type { ItemAtaResponse, AtaResponse } from "@/services/atas";
			...
			<div className="flex items-start justify-between gap-4">
				<div className="min-w-0 flex-1 space-y-1">
					<div className="flex items-center gap-2 flex-wrap">
						...
						<span className="px-1.5 py-0.5 text-[9px] font-bold font-sans uppercase tracking-wider border"
							style={{
								borderColor:
									item.type === "direta"
										? "rgba(37,99,235,0.2)"
										: "rgba(245,158,11,0.2)",
								color:
									item.type === "direta" ? "#1e40af" : "#92400e",
								backgroundColor:
									item.type === "direta"
										? "rgba(37,99,235,0.05)"
					...
					<div className="lg:col-span-4 bg-[#F8FAFE] border border-slate-955/10 p-5 space-y-5 sticky top-4">
						...
						<div className="space-y-4 font-sans text-xs">
							...
							<p className="text-[9px] text-slate-500 font-sans leading-relaxed">
								O checkout validará os limites de compra e exigirá justificativa
								formal. Pedidos seguem para autorização do Órgão Gerenciador.
							</p>
						</div>
					</div>
				</div>
